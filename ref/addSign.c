...
main()
{
    ...
    unsigned char skUnderTest[6][CRYPTO_SECRETKEYBYTES];
    ...
    randombytes_init(entropy_input, "Will Davis");
    for (int i=0; i<6; i++) {
    ...
    do {
        ...
        if ( (ret_val = crypto_sign(sm, &smlen, m, mlen, skUnderTest[count],fp_rsp)) != 0) {
